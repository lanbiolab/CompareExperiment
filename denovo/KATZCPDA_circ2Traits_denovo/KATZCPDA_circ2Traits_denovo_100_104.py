...
@Author: Dong Yi
@Date: 2020.9.26
@Description: 这是对 KATZCPDA denovo 进行复现的代码
'''
import random
import h5py
import math
...
if __name__ == '__main__':
    ...
    # 用pickle数据形式将它存储下来
    with h5py.File('./KATZCPDA_denovo_result_100_104.h5', 'w') as hf:
        hf['tpr_arr'] = tpr_arr
        hf['fpr_arr'] = fpr_arr
    ...
    # with h5py.File('./PlotFigure/KATZCPDA_circ2Traits_denovo_AUC.h5') as hf:
    #     hf['fpr'] = mean_denovo_fpr
    #     hf['tpr'] = mean_denovo_tpr
    # with h5py.File('./PlotFigure/KATZCPDA_circ2Traits_denovo_AUPR.h5') as h:
    ...
    # plt.legend(loc=0)
    # plt.savefig("./FinalResultPng/roc-KATZCPDA_circ2Traits_denovo.png")
