...
def DNN_auto(x_train):
    ...
    # print()
    # decoder layers
    decoded = Dense(450, activation='relu')(encoder_output)
...
def DeepCDA():
    X, labels, label, T, interaction, link_number = prepare_data(
    ...
    with h5py.File(r'E:\pythonProject\KHGAT\data\associations5_10_auc.h5') as hf:
        hf['fpr'] = mean_cross_fpr
        hf['tpr'] = mean_cross_tpr
    with h5py.File(r'E:\pythonProject\KHGAT\data\associations5_10_aupr.h5') as h:
        h['recall'] = mean_cross_recall
        h['precision'] = mean_cross_precision

    # with h5py.File(r'E:\pythonProject\KHGAT\data\associations1_10_auc.h5') as hf:
    #     hf['fpr'] = mean_cross_fpr
    #     hf['tpr'] = mean_cross_tpr
    # with h5py.File(r'E:\pythonProject\KHGAT\data\associations1_10_aupr.h5') as h:
    #     h['recall'] = mean_cross_recall
    #     h['precision'] = mean_cross_precision
