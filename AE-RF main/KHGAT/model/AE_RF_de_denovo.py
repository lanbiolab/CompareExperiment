...
def DeepCDA():
    ...
    with h5py.File(r'E:\pythonProject\KHGAT\data\associations5_denovo_auc.h5') as hf:
        hf['fpr'] = mean_cross_fpr
        hf['tpr'] = mean_cross_tpr
    with h5py.File(r'E:\pythonProject\KHGAT\data\associations5_denovo_aupr.h5') as h:
