...
if __name__ == '__main__':
    ...
    with h5py.File('./PlotFigure/BRWSP_circ2Traits_AUC.h5') as hf:
        hf['fpr'] = mean_cross_fpr
        hf['tpr'] = mean_cross_tpr
    with h5py.File('./PlotFigure/BRWSP_circ2Traits_AUPR.h5') as h:
    ...
    plt.legend(loc=0)
    plt.savefig("./FinalResultPng/roc-BRWSP_circ2Traits.png")
