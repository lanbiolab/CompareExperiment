...
if __name__=="__main__":
    ...
    with h5py.File('./PlotFigure/iCircDA_small_circRNADisease_denovo_AUC.h5') as hf:
        hf['fpr'] = mean_denovo_fpr
        hf['tpr'] = mean_denovo_tpr
    with h5py.File('./PlotFigure/iCircDA_small_circRNADisease_denovo_AUPR.h5') as h:
    ...
    plt.legend(loc=0)
    plt.savefig("./FinalResultPng/roc-iCircDA_MF_small_circRNADisease_denovo.png")
