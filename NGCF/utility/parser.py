...
def parse_args():
    ...
    parser.add_argument('--data_path', nargs='?', default='../Data/dataset1/fold_file/', #注意更改
                        help='Input data path.')
    parser.add_argument('--proj_path', nargs='?', default='',
                        help='Project path.')

    parser.add_argument('--dataset', nargs='?', default='circRNA-disease-fold1', #注意更改
                        help='Choose a dataset from {gowalla, yelp2018, amazon-book}')
    parser.add_argument('--FeaturePath', nargs='?', default='circRNA-disease-fold1',
                        help='Feature save path')  #这里是自己增加的

    parser.add_argument('--pretrain', type=int, default=0,
                        help='0: No pretrain, -1: Pretrain with the learned embeddings, 1:Pretrain with stored models.')
    parser.add_argument('--verbose', type=int, default=1,
                        help='Interval of evaluation.')
    parser.add_argument('--epoch', type=int, default=500, #默认500 #注意更改
